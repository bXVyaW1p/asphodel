...
const Device = StructType({
  ...
  get_serial_number: ffi.Function("int", [
    ref.refType("void"),
    "uint8*",
    ref.types.size_t,
  ]),
  do_transfer: ffi.Function("int", [
    "void*",
    "uint8",
    "uint8*",
    ffi.types.size_t,
    AsphodelCommandCallback,
    "void*",
  ]),
  do_transfer_reset: ffi.Function("int", [
    "void*",
    "uint8",
    "uint8*",
    ffi.types.size_t,
  ...
  start_streaming_packets: ffi.Function("int", [
    "void*",
    "int",
    "int",
    "uint",
  ...
  get_stream_packets_blocking: ffi.Function("int", [
    "void*",
    "uint8*",
    "int*",
    "int",
  ...
  set_connect_callback: ffi.Function("int", [
    "void*",
    AsphodelCommandCallback,
    "void*",
  ]),
...
export function loadAsphodelLibrary(path: string) {
  return ffi.Library(path, {
    ...
    // asphodel_device.h
    asphodel_get_protocol_version: [
      "int",
      [DevicePtr, "uint16*", AsphodelCommandCallback, "void*"],
    ],
    asphodel_get_protocol_version_blocking: ["int", [DevicePtr, "uint16*"]],
    asphodel_get_protocol_version_string: [
      "int",
      [DevicePtr, "void*", ffi.types.size_t, AsphodelCommandCallback, "void*"],
    ],
    asphodel_get_protocol_version_string_blocking: [
      "int",
      [DevicePtr, "void*", ffi.types.size_t],
    ],
    asphodel_get_board_info: [
      "int",
      [
        DevicePtr,
        "void*",
    ...
    asphodel_get_user_tag_locations: [
      "int",
      [DevicePtr, "void*", AsphodelCommandCallback, "void*"],
    ],
    asphodel_get_user_tag_locations_blocking: ["int", [DevicePtr, "void*"]],
    asphodel_get_build_info: [
      "int",
      [DevicePtr, "void*", ffi.types.size_t, AsphodelCommandCallback, "void*"],
    ],
    ...
    asphodel_write_user_tag_string: [
      "int",
      [
        DevicePtr,
        ffi.types.size_t,
    ...
    asphodel_bootloader_jump: [
      "int",
      [DevicePtr, AsphodelCommandCallback, "void*"],
    ],
    asphodel_bootloader_jump_blocking: ["int", [DevicePtr]],

    asphodel_get_reset_flag: [
      "int",
      [DevicePtr, "void*", AsphodelCommandCallback, "void*"],
    ],
    asphodel_get_reset_flag_blocking: ["int", [DevicePtr, "void*"]],

    asphodel_clear_reset_flag: [
      "int",
      [DevicePtr, AsphodelCommandCallback, "void*"],
    ],
    asphodel_clear_reset_flag_blocking: ["int", [DevicePtr]],

    asphodel_get_rgb_count: [
      "int",
      [DevicePtr, "void*", AsphodelCommandCallback, "void*"],
    ],
    asphodel_get_rgb_count_blocking: ["int", [DevicePtr, "void*"]],

    asphodel_get_rgb_values: [
      "int",
      [DevicePtr, "int", "void*", AsphodelCommandCallback, "void*"],
    ],
    asphodel_get_rgb_values_blocking: ["int", [DevicePtr, "int", "void*"]],

    asphodel_set_rgb_values: [
      "int",
      [DevicePtr, "int", "void*", "int", AsphodelCommandCallback, "void*"],
    ],
    ...
    asphodel_set_rgb_values_hex: [
      "int",
      [DevicePtr, "int", "uint32", "int", AsphodelCommandCallback, "void*"],
    ],
    ...
    asphodel_get_led_count: [
      "int",
      [DevicePtr, "void*", AsphodelCommandCallback, "void*"],
    ],
    asphodel_get_led_count_blocking: ["int", [DevicePtr, "void*"]],

    asphodel_get_led_value: [
      "int",
      [DevicePtr, "int", "void*", AsphodelCommandCallback, "void*"],
    ],
    asphodel_get_led_value_blocking: ["int", [DevicePtr, "int", "void*"]],

    asphodel_set_led_value: [
      "int",
      [DevicePtr, "int", "uint8", "int", AsphodelCommandCallback, "void*"],
    ],
    ...
    asphodel_set_device_mode: [
      "int",
      [DevicePtr, "uint8", AsphodelCommandCallback, "void*"],
    ],
    asphodel_set_device_mode_blocking: ["int", [DevicePtr, "uint8"]],

    asphodel_get_device_mode: [
      "int",
      [DevicePtr, "uint8*", AsphodelCommandCallback, "void*"],
    ],
    ...
    asphodel_bootloader_start_program: [
      "int",
      [DevicePtr, AsphodelCommandCallback, "void*"],
    ],
    asphodel_bootloader_start_program_blocking: ["int", [DevicePtr]],

    asphodel_get_bootloader_page_info: [
      "int",
      [DevicePtr, "uint32*", "uint8*", AsphodelCommandCallback, "void*"],
    ],
    ...
    asphodel_get_bootloader_block_sizes: [
      "int",
      [DevicePtr, "uint16*", "uint8*", AsphodelCommandCallback, "void*"],
    ],
    ...
    asphodel_start_bootloader_page: [
      "int",
      [
        DevicePtr,
        "uint32",
    ...
    asphodel_write_bootloader_code_block: [
      "int",
      [DevicePtr, "uint8*", ffi.types.size_t, AsphodelCommandCallback, "void*"],
    ],
    ...
    asphodel_write_bootloader_page: [
      "int",
      [
        DevicePtr,
        "uint8*",
    ...
    asphodel_verify_bootloader_page: [
      "int",
      [DevicePtr, "uint8*", ffi.types.size_t, AsphodelCommandCallback, "void*"],
    ],
    ...
    // asphodel_stream.h
    asphodel_get_stream_count: [
      "int",
      [DevicePtr, "int*", "uint8*", "uint8*", AsphodelCommandCallback, "void*"],
    ],
    ...
    asphodel_get_stream_format: [
      "int",
      [DevicePtr, "int", StreamInfoPtr, AsphodelCommandCallback, "void*"],
    ],
    ...
    asphodel_enable_stream: [
      "int",
      [DevicePtr, "int", "int", AsphodelCommandCallback, "void*"],
    ],
    asphodel_enable_stream_blocking: ["int", [DevicePtr, "int", "int"]],

    asphodel_warm_up_stream: [
      "int",
      [DevicePtr, "int", "int", AsphodelCommandCallback, "void*"],
    ],
    asphodel_warm_up_stream_blocking: ["int", [DevicePtr, "int", "int"]],

    asphodel_get_stream_status: [
      "int",
      [DevicePtr, "int", "int*", "int*", AsphodelCommandCallback, "void*"],
    ],
    ...
    asphodel_get_channel_count: [
      "int",
      [DevicePtr, "int*", AsphodelCommandCallback, "void*"],
    ],
    asphodel_get_channel_count_blocking: ["int", [DevicePtr, "int*"]],

    asphodel_get_channel: [
      "int",
      [
        DevicePtr,
        "int",
        ref.refType(ChannelInfoPtr),
        AsphodelCommandCallback,
        "void*",
      ],
    ],
    ...
    asphodel_get_channel_info: [
      "int",
      [DevicePtr, "int", ChannelInfoPtr, AsphodelCommandCallback, "void*"],
    ],
    ...
    asphodel_get_channel_coefficients: [
      "int",
      [DevicePtr, "int", "float*", "uint8*", AsphodelCommandCallback, "void*"],
    ],
    ...
    asphodel_get_channel_calibration: [
      "int",
      [
        DevicePtr,
        "int",
        "int*",
        ChannelCallibrationPtr,
        AsphodelCommandCallback,
        "void*",
      ],
    ],
    ...
    asphodel_set_strain_outputs: [
      "int",
      [DevicePtr, "int", "int", "int", "int", AsphodelCommandCallback, "void*"],
    ],
    ...
    asphodel_enable_accel_self_test: [
      "int",
      [DevicePtr, "int", "int", AsphodelCommandCallback, "void*"],
    ],
    ...
    asphodel_get_ctrl_var_info: [
      "int",
      [DevicePtr, "int", CtrlVarInfoPtr, AsphodelCommandCallback, "void*"],
    ],
    ...
    asphodel_get_ctrl_var: [
      "int",
      [DevicePtr, "int", "int32*", AsphodelCommandCallback, "void*"],
    ],
    asphodel_get_ctrl_var_blocking: ["int", [DevicePtr, "int", "int32*"]],

    asphodel_set_ctrl_var: [
      "int",
      [DevicePtr, "int", "int32", AsphodelCommandCallback, "void*"],
    ],
    ...
    asphodel_get_gpio_port_count: [
      "int",
      [DevicePtr, "int*", ffi.types.size_t, AsphodelCommandCallback, "void*"],
    ],
    asphodel_get_gpio_port_count_blocking: ["int", [DevicePtr, "int*"]],

    asphodel_get_gpio_port_name: [
      "int",
      [
        DevicePtr,
        "int",
    ...
    asphodel_get_gpio_port_info: [
      "int",
      [DevicePtr, "int", GPIOPortInfoPtr, AsphodelCommandCallback, "void*"],
    ],
    ...
    asphodel_get_gpio_port_values: [
      "int",
      [DevicePtr, "int", "uint32*", AsphodelCommandCallback, "void*"],
    ],
    ...
    asphodel_set_gpio_port_modes: [
      "int",
      [DevicePtr, "int", "uint8", "uint32", AsphodelCommandCallback, "void*"],
    ],
    ...
    asphodel_get_info_region_count: [
      "int",
      [DevicePtr, "int*", AsphodelCommandCallback, "void*"],
    ],
    asphodel_get_info_region_count_blocking: ["int", [DevicePtr, "int*"]],

    asphodel_get_info_region_name: [
      "int",
      [DevicePtr, "int", "uint8*", "uint8*", AsphodelCommandCallback, "void*"],
    ],
    ...
    asphodel_get_stack_info: [
      "int",
      [DevicePtr, "uint32*", AsphodelCommandCallback, "void*"],
    ],
    ...
    asphodel_start_radio_scan: [
      "int",
      [DevicePtr, AsphodelCommandCallback, "void*"],
    ],
    asphodel_start_radio_scan_blocking: ["int", [DevicePtr]],

    asphodel_get_raw_radio_scan_results: [
      "int",
      [
        DevicePtr,
        "uint32*",
    ...
    asphodel_get_raw_radio_extra_scan_results: [
      "int",
      [
        DevicePtr,
        ExtraScanResultPtr,
    ...
    asphodel_get_radio_ctrl_vars: [
      "int",
      [DevicePtr, "uint8*", "uint8*", AsphodelCommandCallback, "void*"],
    ],
    ...
    asphodel_restart_remote_app: [
      "int",
      [DevicePtr, AsphodelCommandCallback, "void*"],
    ],
    asphodel_restart_remote_app_blocking: ["int", [DevicePtr]],

    asphodel_restart_remote_boot: [
      "int",
      [DevicePtr, AsphodelCommandCallback, "void*"],
    ],
    ...
    asphodel_reset_rf_power_timeout: [
      "int",
      [DevicePtr, "uint32", AsphodelCommandCallback, "void*"],
    ],
    ...
    asphodel_get_setting_info: [
      "int",
      [DevicePtr, "int", SettingInfoPtr, AsphodelCommandCallback, "void*"],
    ],
    ...
    asphodel_get_custom_enum_counts: [
      "int",
      [DevicePtr, "uint8*", "uint8*", AsphodelCommandCallback, "void*"],
    ],
    ...
    asphodel_get_custom_enum_value_name: [
      "int",
      [
        DevicePtr,
        "int",
    ...
    asphodel_get_setting_category_count: [
      "int",
      [DevicePtr, "int*", AsphodelCommandCallback, "void*"],
    ],
    asphodel_get_setting_category_count_blocking: ["int", [DevicePtr, "int*"]],

    asphodel_get_setting_category_name: [
      "int",
      [DevicePtr, "int", "uint8*", "uint8*", AsphodelCommandCallback, "void*"],
    ],
    ...
    asphodel_get_setting_category_settings: [
      "int",
      [DevicePtr, "int", "uint8*", "uint8*", AsphodelCommandCallback, "void*"],
    ],
    ...
    asphodel_get_supply_info: [
      "int",
      [DevicePtr, "int", SupplyInfoPtr, AsphodelCommandCallback, "void*"],
    ],
    ...
    asphodel_tcp_find_devices: [
      "int",
      [ref.refType(DevicePtr), ref.refType(ffi.types.size_t)],
    ],
    asphodel_tcp_find_devices_filter: [
      "int",
      [ref.refType(DevicePtr), ref.refType(ffi.types.size_t), "uint32"],
    ],
    asphodel_tcp_poll_devices: ["int", ["int"]],
    asphodel_tcp_create_device: [
      "int",
      ["uint8*", "uint16", "int", "uint8*", ref.refType(DevicePtr)],
    ],

    // asphodel_unit_format.h
    asphodel_create_unit_formatter: [
      UnitFormatterPtr,
      ["uint8", "double", "double", "double", "int"],
    ],
    asphodel_create_custom_unit_formatter: [
      UnitFormatterPtr,
      ["double", "double", "double", "uint8*", "uint8*", "uint8*"],
    ],
    asphodel_format_value_ascii: [
      "int",
      ["uint8*", ffi.types.size_t, "uint8", "double", "int", "double"],
    ],
    asphodel_format_value_utf8: [
      "int",
      ["uint8*", ffi.types.size_t, "uint8", "double", "int", "double"],
    ],
    asphodel_format_value_html: [
      "int",
      ["uint8*", ffi.types.size_t, "uint8", "double", "int", "double"],
    ],
  ...
  public getSetting() {
    ...
    switch (this.inner.deref().setting_type) {
      case SETTING_TYPE_BYTE:
        return new ByteSettingWrapper(this.lib, union.byte_setting);
      case SETTING_TYPE_BYTE_ARRAY:
        return new ByteArraySettingWrapper(this.lib, union.byte_array_setting);
      case SETTING_TYPE_INT32:
        return new Int32SettingWrapper(this.lib, union.int32_setting);
      case SETTING_TYPE_INT32_SCALED:
        return new Int32ScaledSettingWrapper(
          this.lib,
          union.int32_scaled_setting
        );
      case SETTING_TYPE_FLOAT:
        return new FloatSettingWrapper(this.lib, union.float_setting);
      case SETTING_TYPE_FLOAT_ARRAY:
        return new FloatArraySettingWrapper(
          this.lib,
          union.float_array_setting
        );
      case SETTING_TYPE_CUSTOM_ENUM:
        return new CustomEnumSettingWrapper(
          this.lib,
...
export class StreamInfoWrapper {
  ...
  public getChannelIndexList() {
    let b = this.inner
      .deref()
      .channel_index_list.buffer.reinterpret(this.inner.deref().channel_count);
...
export class ChannelDecoderWrapper {
  ...
  public getSubChannels() {
    ...
    let b2 = this.inner
      .deref()
      .subchannel_names.buffer.reinterpret(ffi.types.size_t.size * cnt);
  ...
  public setDecodeCallback(
    ...
    this.cb = ffi.Callback(
      "void",
      ["uint64", "double*", ffi.types.size_t, ffi.types.size_t, "void*"],
      (
        __conter: number,
        __data: ref.Pointer<any>,
        __samples: number,
        __subchannels: number,
        cls
      ) => {
        let fb = __data.reinterpret(
          ffi.types.double.size * __samples * __subchannels
        );
        let floats = new Float64Array(__samples * __subchannels);
        for (let i = 0; i < floats.length; i++) {
          floats[i] =
            os.endianness() == "LE"
              ? fb.readDoubleLE(i * ffi.types.double.size)
              : fb.readDoubleBE(i * ffi.types.double.size);
        }
...
export class StreamDecoderWrapper {
  ...
  public getDecoders() {
    ...
    let b2 = this.inner
      .deref()
      .decoders.buffer.reinterpret(ffi.types.size_t.size * cnt);
...
export class DeviceDecoderWrapper {
  ...
  public getStreamIds() {
    let b = this.inner
      .deref()
      .stream_ids.buffer.reinterpret(this.inner.deref().streams);
    let a = new Uint8Array(b.length);
    b.copy(a);
    return a;
  }
  ...
  public setUnknownIdCallback(cb: (id: number) => void) {
    this.cb = ffi.Callback("void", ["uint8", "void*"], (__id: number, cls) => {
      cb(__id);
    });
...
export class ChannelInfoWrapper {
  ...
  public getName() {
    return this.inner
      .deref()
      .name.buffer.reinterpret(this.inner.deref().name_length)
      .toString("utf-8");
  }
  ...
  public getCoefficients() {
    ...
    for (let i = 0; i < len; i++) {
      floats[i] =
        os.endianness() == "LE"
          ? b.readFloatLE(i * ffi.types.float.size)
  ...
  public getChunks() {
    ...
    let list: Buffer = this.inner
      .deref()
      .chunks.buffer.reinterpret(count * ffi.types.size_t.size);
    let lengths: Buffer = this.inner
      .deref()
      .chunk_lengths.buffer.reinterpret(count);
 ...
 must NOT be used with this function. */
  ...
  public getStrainBridgeSubchannel(bridge_index: number) {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_get_strain_bridge_subchannel(
        this.inner,
        bridge_index,
        si
      )
  ...
  public getStrainBridgeValues(bridge_index: number) {
    ...
    for (let i = 0; i < 4; i++) {
      floats[i] =
        os.endianness() == "LE"
          ? fb.readFloatLE(i * ffi.types.float.size)
          : fb.readFloatBE(i * ffi.types.float.size);
    }
    return floats;
  }

  public checkStrainResistances(
    bridge_index: number,
    baseline: number,
    positive_high: number,
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_check_strain_resistances(
        this.inner,
        bridge_index,
        baseline,
        positive_high,
  ...
  public checkAccelSelfTest(disabled: Float64Array, enabled: Float64Array) {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_check_accel_self_test(this.inner, bd, be, pas)
    );
    return pas.deref();
  }
}
...
export class StreamAndChannelsWrapper {
  ...
  constructor(
    stream_id: number,
    stream_info: StreamInfoWrapper,
    channel_infos: ChannelInfoWrapper[]
  ) {
    ...
    channel_infos.forEach((item, i) => {
      ...
      if (ffi.types.size_t.size == 4) {
        ...
        if (os.endianness() == "BE") {
          cib.writeBigUInt64BE(
            BigInt(buv.address()),
            i * ffi.types.size_t.size
          );
        } else {
          cib.writeBigUInt64LE(
            BigInt(buv.address()),
            i * ffi.types.size_t.size
          );
        }
    ...
    if (ffi.types.size_t.size == 4) {
      if (os.endianness() == "BE") {
        back.writeUInt32BE(
          stream_info.inner.address(),
          1 * ffi.types.size_t.size
        );
      ...
      if (os.endianness() == "BE") {
        back.writeBigUInt64BE(
          BigInt(stream_info.inner.address()),
          1 * ffi.types.size_t.size
        );
        back.writeBigUInt64BE(BigInt(cib.address()), 2 * ffi.types.size_t.size);
      } else {
        back.writeBigUInt64LE(
          BigInt(stream_info.inner.address()),
          1 * ffi.types.size_t.size
        );
 ...
 */
  public getSerialNumber(): string {
    ...
    checkForError(
      this.lib,
      this.inner.deref().get_serial_number(this.inner, buf, 64)
    );
 ...
 */
  public doTransfer(
    command: number,
    parameters: number[],
    callback: (status: number, params: Uint8Array) => void
  ) {
    let buf = Buffer.from(new Uint8Array(parameters));

    this.transfer_cb = ffi.Callback(
      "void",
      ["int", "uint8*", ffi.types.size_t, "void*"],
      (
        status: number,
        params: ref.Pointer<any>,
        param_length: number,
        closure
      ) => {
 ...
 */
  public startStreamingPackets(
    ...
    this.streaming_cb = ffi.Callback(
      "int",
      ["int", "uint8*", ffi.types.size_t, ffi.types.size_t, "void*"],
      (
        status: number,
        stream_data: ref.Pointer<any>,
        packet_size: number,
        packet_count__: number,
        closure
      ) => {
 ...
 */
  public async getStreamPackets(count: number, timeout: number) {
    ...
    checkForError(
      ...
      this.inner
        .deref()
        .get_stream_packets_blocking(this.inner, buf, countptr, timeout)
    );
 ...
 */
  public poll(milliseconds: number): number {
    ...
    checkForError(
      this.lib,
      this.inner.deref().poll_device(this.inner, milliseconds, completed)
    );
 ...
 * @param callback 
 */
  public setConnectCallBack(
    callback: (status: number, connected: number) => void
  ) {
    this.connect_cb = ffi.Callback(
      "void",
      ["int", "int", "void*"],
    ...
    checkForError(
      ...
      this.inner
        .deref()
        .set_connect_callback(this.inner, this.connect_cb, ref.NULL)
    );
  }
  /**
 ...
 */
  public getRemoteDevice(): DeviceWrapper {
    ...
    checkForError(
      this.lib,
      this.inner.deref().get_remote_device(this.inner, pointer)
    );
 ...
 */
  public ReconnectDevice(): DeviceWrapper {
    ...
    checkForError(
      this.lib,
      this.inner.deref().reconnect_device(this.inner, pointer)
    );
    return new DeviceWrapper(this.lib, pointer.deref());
  }
  /**
 ...
 */
  public ReconnectDeviceBootloader(): DeviceWrapper {
    ...
    checkForError(
      this.lib,
      this.inner.deref().reconnect_device_bootloader(this.inner, pointer)
    );
    return new DeviceWrapper(this.lib, pointer.deref());
  }
  /**
 ...
 */
  public ReconnectDeviceApplication(): DeviceWrapper {
    ...
    checkForError(
      this.lib,
      this.inner.deref().reconnect_device_application(this.inner, pointer)
    );
    return new DeviceWrapper(this.lib, pointer.deref());
  }
  /**
 ...
 */
  public errorCallback(
    callback: (devicewrapper: DeviceWrapper, status: number) => void
  ) {
    this.error_cb = ffi.Callback(
      "int",
      ["void*", "int", "void*"],
 ...
 */
  public async getProtocalVersion() {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_get_protocol_version_blocking(this.inner, ptr)
    );
    return ptr.deref();
  }
  /**
  ...
  public async getProtocalVersionString() {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_get_protocol_version_string_blocking(
        this.inner,
        buffer,
        buffer.length
      )
 ...
 */
  public async getBoardInfo() {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_get_board_info_blocking(
        this.inner,
        revptr,
        buffer,
        buffer.length
 ...
 */
  public async writeNVMRaw(buff: Uint8Array, start_address: number) {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_write_nvm_raw_blocking(
        this.inner,
        start_address,
        b,
        b.length
 ...
 */
  public async writeNVMSection(buff: Uint8Array, start_address: number) {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_write_nvm_section_blocking(
        this.inner,
        start_address,
        b,
        b.length
 ...
 */
  public async readNVmRaw(start_address: number, len: number) {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_read_nvm_raw_blocking(
        this.inner,
        start_address,
        b,
        lenptr
 ...
 */
  public async readNVMSection(start_address: number, len: number) {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_read_nvm_section_blocking(
        this.inner,
        start_address,
        b,
        len
 ...
 */
  public async readUserTagString(offset: number, length: number) {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_read_user_tag_string_blocking(
        this.inner,
        offset,
        length,
        buf
 ...
 * @param size 
 */
  public async writeUserTagString(
    buffer: string,
    offset: number,
    size: number
  ) {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_write_user_tag_string_blocking(
        this.inner,
        offset,
        size,
        b
 ...
 */
  public async getBootloaderInfo() {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_get_bootloader_info_blocking(
        this.inner,
        buf,
        buf.length
      )
 ...
 */
  public async setRGBValues(
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_set_rgb_values_blocking(
        this.inner,
        index,
        buf,
        instant ? 1 : 0
 ...
 */
  public async setRGBValuesHex(
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_set_rgb_values_hex_blocking(
        this.inner,
        index,
        values,
        instant ? 1 : 0
 ...
 */
  public async setLEDValue(index: number, value: number, instant: boolean) {
    checkForError(
      this.lib,
      this.lib.asphodel_set_led_value_blocking(
        this.inner,
        index,
        value,
        instant ? 1 : 0
 ...
 */
  public async getSettingDefault(index: number, length: number) {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_get_setting_default_blocking(
        this.inner,
        index,
        buf,
        ptr
 ...
 */
  public async getCustomEnumValueName(index: number, value: number) {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_get_custom_enum_value_name_blocking(
        this.inner,
        index,
        value,
        buf,
 ...
 */
  public async getSettingCategoryName(index: number) {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_get_setting_category_name_blocking(
        this.inner,
        index,
        buf,
        ptr
 ...
 */
  public async getSettingCategorySetting(index: number, length: number) {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_get_setting_category_settings_blocking(
        this.inner,
        index,
        buf,
        ptr
 ...
 */
  public async setGPIOPortMode(index: number, mode: number, pins: number) {
    checkForError(
      this.lib,
      this.lib.asphodel_set_gpio_port_modes_blocking(
        this.inner,
        index,
        mode,
        pins
 ...
 */
  public async doSpiTransfer(
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_do_spi_transfer_blocking(
        this.inner,
        index,
        txbuf,
        rxbuf,
 ...
 */
  public async doI2cWrite(index: number, addr: number, tx_data: Uint8Array) {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_do_i2c_write_blocking(
        this.inner,
        index,
        addr,
        txbuf,
 ...
 */
  public async doI2cRead(index: number, addr: number, read_length: number) {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_do_i2c_read_blocking(
        this.inner,
        index,
        addr,
        txbuf,
 ...
 */
  public async doI2cWriteRead(
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_do_i2c_write_read_blocking(
        this.inner,
        index,
        addr,
        txbuf,
 ...
 */
  public async doRadioFixedTest(
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_do_radio_fixed_test_blocking(
        this.inner,
        channel,
        duration,
        mode
 ...
 */
  public async doRadioSweepTest(
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_do_radio_sweep_test_blocking(
        this.inner,
        start_channel,
        stop_channel,
        hop_interval,
 ...
 */
  public async getInfoRegionName(index: number) {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_get_info_region_name_blocking(
        this.inner,
        index,
        buf,
        ptr
 ...
 */
  public async echoRaw(data: Uint8Array) {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_echo_raw_blocking(
        this.inner,
        txbuf,
        txbuf.length,
        rxbuf,
 ...
 */
  public async echoTransaction(data: Uint8Array) {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_echo_transaction_blocking(
        this.inner,
        txbuf,
        txbuf.length,
        rxbuf,
 ...
 */
  public async echoParams(data: Uint8Array) {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_echo_params_blocking(
        this.inner,
        txbuf,
        txbuf.length,
        rxbuf,
 ...
 */
  public async getStreamChannels(index: number, len: number) {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_get_stream_channels_blocking(
        this.inner,
        index,
        arr,
        lenptr
 ...
 */
  public async enableStream(index: number, enable: boolean) {
    checkForError(
      this.lib,
      this.lib.asphodel_enable_stream_blocking(
        this.inner,
        index,
        enable ? 1 : 0
      )
 ...
 */
  public async warmUpStream(index: number, enable: boolean) {
    checkForError(
      this.lib,
      this.lib.asphodel_warm_up_stream_blocking(
        this.inner,
        index,
        enable ? 1 : 0
      )
 ...
 */
  public async getStreamRateInfo(index: number) {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_get_stream_rate_info_blocking(
        this.inner,
        index,
        avail,
        ci,
 ...
 */
  public async getChannelCoefficients(index: number, length: number) {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_get_channel_coefficients_blocking(
        this.inner,
        index,
        fbuf,
        lptr
    ...
    for (let i = 0; i < length; i++) {
      floats[i] =
        os.endianness() == "LE"
          ? fbuf.readFloatLE(i * ffi.types.float.size)
          : fbuf.readFloatBE(i * ffi.types.float.size);
    }
    return {
      coeficients: floats,
 ...
 */
  async getChannelChunk(index: number, chunk_number: number, length: number) {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_get_channel_chunk_blocking(
        this.inner,
        index,
        chunk_number,
        chbuff,
 ...
 */
  public async channelSpecific(
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_channel_specific_blocking(
        this.inner,
        index,
        dbuf,
        dbuf.length,
 ...
 */
  public async getChannelCalibration(index: number) {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_get_channel_calibration_blocking(
        this.inner,
        index,
        avail,
        ptr
 ...
 */
  public async getBootLoaderPageInfo(length: number) {
    ...
    for (let i = 0; i < ub.length; i++) {
      ub[i] =
        os.endianness() == "LE"
          ? buf.readUint32LE(i * ffi.types.float.size)
          : buf.readUint32BE(i * ffi.types.float.size);
    }
    return {
      page_info: ub,
 ...
 */
  public async getBootLoaderblockSizes(length: number) {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_get_bootloader_block_sizes_blocking(this.inner, buf, l)
    );
 ...
 */
  public async startBootLoaderPage(page_number: number, nonce: Uint8Array) {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_start_bootloader_page_blocking(
        this.inner,
        page_number,
        buf,
        buf.length
 ...
 */
  public async writeBootLoaderCodeBlock(data: Uint8Array) {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_write_bootloader_code_block_blocking(
        this.inner,
        db,
        db.length
      )
 ...
 */
  public async finishBootloaderPage(mac_tag: Uint8Array) {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_finish_bootloader_page_blocking(
        this.inner,
        mac,
        mac.length
      )
 ...
 */
  public async writeBoatloaderPage(data: Uint8Array, block_sizes: Uint16Array) {
    ...
    block_sizes.forEach((size, i) => {
      os.endianness() == "LE"
        ? bbuf.writeUint16LE(size, i * 2)
        : bbuf.writeUint16BE(size, i * 2);
    });
    checkForError(
      this.lib,
      this.lib.asphodel_write_bootloader_page_blocking(
        this.inner,
        dbuf,
        data.length,
        bbuf,
 ...
 */
  public async verifyBootloaderPage(mac_tag: Uint8Array) {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_verify_bootloader_page_blocking(
        this.inner,
        mb,
        mb.length
      )
 ...
 * @param negative_side 
 */
  public async setStrainOutputs(
    channel_index: number,
    bridge_index: number,
    positive_side: number,
    negative_side: number
  ) {
    checkForError(
      this.lib,
      this.lib.asphodel_set_strain_outputs_blocking(
        this.inner,
        channel_index,
        bridge_index,
        positive_side,
 ...
 */
  public async enableAccelSelfTest(channel_index: number, enable: boolean) {
    checkForError(
      this.lib,
      this.lib.asphodel_enable_accel_self_test_blocking(
        this.inner,
        channel_index,
        enable ? 1 : 0
      )
 ...
 */
  public async getCtrlVarInfo(index: number) {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_get_ctrl_var_info_blocking(this.inner, index, ptr)
    );
 ...
 */
  public async getRawRadioScanResults(length: number) {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_get_raw_radio_scan_results_blocking(
        this.inner,
        res,
        lptr
      )
    ...
    for (let i = 0; i < ub.length; i++) {
      ub[i] =
        os.endianness() == "LE"
          ? res.readUint32LE(i * 4)
          : res.readUint32BE(i * 4);
    }
    return ub;
  }
  /**
 ...
 */
  public async getRadioScanResults(length: number) {
    ...
    for (let i = 0; i < ub.length; i++) {
      ub[i] =
        os.endianness() == "LE"
          ? resbuff.readUint32LE(i * 4)
          : resbuff.readUint32BE(i * 4);
    }
 ...
 */
  public async getRawRadioExtraScanResults(length: number) {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_get_raw_radio_extra_scan_results_blocking(
        this.inner,
        res,
        lptr
      )
    ...
    for (let i = 0; i < (lptr.deref() as number); i++) {
      results.push(
        new ExtraScanResultWrapper(
          new ExtraScanResult(res.subarray(i * ExtraScanResult.size))
        )
      );
    }
    return results;
 ...
 */
  public async getRadioExtraScanResults(length: number) {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_get_radio_extra_scan_results_blocking(
        this.inner,
        res,
        lptr
      )
    ...
    let resbuff = res
      .deref()
      .buffer.reinterpret((lptr.deref() as number) * ExtraScanResult.size);
    for (let i = 0; i < (lptr.deref() as number); i++) {
      results.push(
        new ExtraScanResultWrapper(
          new ExtraScanResult(resbuff.subarray(i * ExtraScanResult.size))
        )
      );
    }
 ...
 */
  public async getRadioScanPower(serials: Uint32Array) {
    ...
    serials.forEach((s, i) => {
      os.endianness() == "BE"
        ? sb.writeInt32BE(s, i * 4)
        : sb.writeInt32LE(s, i * 4);
    });
    let res = Buffer.alloc(serials.length);
    checkForError(
      this.lib,
      this.lib.asphodel_get_radio_scan_power_blocking(
        this.inner,
        sb,
        res,
        serials.length
 ...
 */
  public async getRadioStatus() {
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_get_radio_status_blocking(
        this.inner,
        con,
        ser,
        pr,
...
export function createStreamDecoder(
  ...
  stream_bit_offset: number
) {
  let dec = ref.alloc(StreamDecoderPtr);
  checkForError(
    lib,
    lib.asphodel_create_stream_decoder(
      stream_and_channels.inner,
      stream_bit_offset,
      dec
    )
  );
...
export function createChannelDecoder(
  lib: any,
  channel_info: ChannelInfoWrapper,
  channel_bit_offset: number
) {
  let ptr = ref.alloc(ChannelDecoderPtr);
  checkForError(
    lib,
    lib.asphodel_create_channel_decoder(
      channel_info.inner,
      channel_bit_offset,
      ptr
    )
 ...
 * @returns 
 */
export function createDeviceDecoder(
  lib: any,
  stream_and_channels: StreamAndChannelsWrapper[],
  filler_bits: number,
  id_bits: number
  ...
  checkForError(
    lib,
    lib.asphodel_create_device_decoder(
      cib,
      stream_and_channels.length,
      filler_bits,
      id_bits,
      dec
    )
...
class TCP {
  ...
  public async findDevices(n: number) {
    ...
    checkForError(
      ...
      this.lib.asphodel_tcp_find_devices(
        list as ref.Pointer<ref.Pointer<any>>,
        lenPtr
      )
    );
  ...
  public createDevice(
    ...
    checkForError(
      this.lib,
      this.lib.asphodel_tcp_create_device(
        Buffer.from(host) as any,
        parseInt(port),
        timeout,
        Buffer.from(serial),
        ptr
